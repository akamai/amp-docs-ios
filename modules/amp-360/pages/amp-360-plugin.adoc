...
The Amp 360 plugin allows you to play corretly content formatted for virtual reality purposes.
...
The first step is to use the 360 plugin is to import the plugin.
